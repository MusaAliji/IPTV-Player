...
{
    /// <inheritdoc />
    public partial class Phase2Implementation : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FavoriteChannels = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    Language = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                    EnableNotifications = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    AutoPlayNext = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    PreferredQuality = table.Column<int>(type: "int", nullable: true),
                    SubtitlesEnabled = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    SubtitleLanguage = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()"),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()")
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ViewingHistories_Channels_ChannelId",
                        column: x => x.ChannelId,
                        principalTable: "Channels",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ViewingHistories_ChannelId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ViewingHistories_StartTime",
                table: "ViewingHistories",
                column: "StartTime");
